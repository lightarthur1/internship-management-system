...
Working on database integration and API endpoints for user management. Created RESTful endpoints for CRUD operations. Implemented data validation middleware.
 ...
 <div className="flex gap-4 mt-6">
  ...
  {/* Like */}
  <button className="flex-1 flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-3 text-gray-700 hover:bg-gray-50">
    <LuThumbsUp />
    Like
  </button>

  {/* Dislike */}
  <button className="flex-1 flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-3 text-gray-700 hover:bg-green-900">
    <LuThumbsDown />
    Dislike
  </button>

  {/* Comment */}
  <button className="flex-1 flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-3 text-gray-700 hover:bg-green-900 text-white">
    <BiComment />
    Comment
  </button>
